...
if (isset($_GET['hapus'])) {
    ...
    $query = "SELECT image, barcode_image FROM products WHERE id = $productId";
...
<head>
    ...
    <style>
        ...
        .product-image {
            @apply w-10 h-10 rounded-md object-cover border border-gray-200;
        }
        .modal {
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                ...
                                <tr class="hover:bg-purple-50 transition-colors">
                                    ...
                                    <td class="px-4 py-3 text-center">
                                        ...
                                        <?php else: ?>
                                            <span class="badge-danger px-2 py-1 rounded-full text-xs">
                                                Habis
                                            </span>
                                        <?php endif; ?>
                                    </td>
                                    ...
                                    <td class="px-4 py-3 text-right">
                                        <div class="flex justify-end space-x-2">
                                            <a href="manage_product.php?edit=<?= (int)$row['id'] ?>" 
                        ...
                        <div class="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
                            <div>
                                <p class="text-sm text-gray-700">
                                    Menampilkan <span class="font-medium"><?= ($offset + 1) ?></span> sampai <span class="font-medium"><?= min($offset + $limit, $totalData) ?></span> dari <span class="font-medium"><?= $totalData ?></span> produk
                                </p>
                            </div>
                            <div>
                ...
                <div>
                    ...
                    <select name="fid_category_edit" class="w-full px-3 py-2 text-sm border border-gray-300 rounded-md focus:ring-2 focus:ring-purple-500 focus:border-transparent" required>
                        ...
                        while ($category = mysqli_fetch_assoc($resultKategori)) { 
                            $selected = ($category['id'] == $editProduct['fid_category']) ? 'selected' : '';
                        ?>
