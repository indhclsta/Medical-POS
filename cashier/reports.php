...
<body class="bg-gray-50">
        ...
        <div class="ml-64 flex-1 overflow-y-auto">
            <header class="bg-white shadow-sm">
                <div class="flex justify-between items-center px-6 py-4">
                    <h2 class="text-xl font-semibold text-gray-800">Laporan & Analisis</h2>
            ...
            <main class="p-6">
                ...
                <div class="bg-white rounded-xl shadow-md p-6 mb-6 border-l-4 border-purple-600">
                    ...
                    <form method="GET" class="space-y-4">
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div>
                                <label class="block text-sm font-medium text-gray-600 mb-2" for="report-type">
                                    Jenis Laporan
                                </label>
                                <select name="report_type" id="report-type" class="bg-gray-50 border border-gray-300 rounded-lg w-full py-2 px-3 text-gray-700 focus:outline-none focus:ring-2 focus:ring-purple-500">
                            ...
                            <div id="dateRangeFields" class="<?= $report_type != 'periode' ? 'hidden' : '' ?>">
                                <label class="block text-sm font-medium text-gray-600 mb-2">Rentang Tanggal</label>
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-2">
                                    <input type="date" name="start_date" value="<?= $start_date ?>" class="bg-gray-50 border border-gray-300 rounded-lg w-full py-2 px-3 text-gray-700 focus:outline-none focus:ring-2 focus:ring-purple-500">
                                    <input type="date" name="end_date" value="<?= $end_date ?>" class="bg-gray-50 border border-gray-300 rounded-lg w-full py-2 px-3 text-gray-700 focus:outline-none focus:ring-2 focus:ring-purple-500">
                                </div>
                            </div>

                            <div>
                                <label class="block text-sm font-medium text-gray-600 mb-2" for="chart-type">
                                    Tipe Grafik
                                </label>
                                <select name="chart_type" id="chart-type" class="bg-gray-50 border border-gray-300 rounded-lg w-full py-2 px-3 text-gray-700 focus:outline-none focus:ring-2 focus:ring-purple-500">
                        ...
                        <div class="flex justify-end space-x-3">
                            <?php if ($report_type == 'periode' && !empty($start_date)): ?>
                                <a href="reports.php" class="bg-gray-200 hover:bg-gray-300 text-gray-800 font-bold py-2 px-4 rounded-lg transition">
                                    Reset
                                </a>
                            <?php endif; ?>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                    <div class="stat-card bg-white rounded-lg p-6 shadow">
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="text-xs mt-1 text-gray-500"><?= $report_type == 'periode' && !empty($start_date) ? 'Periode terpilih' : 'Keseluruhan' ?></p>
                            </div>
                    ...
                    <div class="stat-card bg-white rounded-lg p-6 shadow">
                        ...
                        <div class="mt-4">
                            <a href="#" class="text-purple-600 text-sm hover:underline">Lihat Grafik →</a>
                        </div>
                    </div>
                    ...
                    <div class="stat-card bg-white rounded-lg p-6 shadow">
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="text-xs mt-1 text-gray-500">Keuntungan bersih</p>
                            </div>
                            <div class="bg-purple-100 p-3 rounded-full">
                        ...
                        <div class="mt-4">
                            <a href="#" class="text-purple-600 text-sm hover:underline">Analisis →</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-xl shadow-md p-6 mb-6 border-l-4 border-purple-600">
                    <div class="flex justify-between items-center mb-6">
                        ...
                        <div class="flex space-x-2 no-print">
                            <button onclick="preparePrint()" class="bg-purple-600 hover:bg-purple-700 text-white px-4 py-2 rounded-lg text-sm flex items-center space-x-1 transition">
                                <i class="fas fa-print mr-1"></i>
                                <span>Cetak</span>
                            </button>
                            <button onclick="downloadPDF()" class="bg-red-600 hover:bg-red-700 text-white px-4 py-2 rounded-lg text-sm flex items-center space-x-1 transition">
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        <!-- Sales Chart -->
                        <div>
                            <h4 class="font-medium text-gray-600 mb-3">Grafik Penjualan</h4>
                        ...
                        <!-- Margin Chart -->
                        <div>
                            <h4 class="font-medium text-gray-600 mb-3">Grafik Margin</h4>
                            <div class="chart-container">
                ...
                <div class="bg-white rounded-xl shadow-md overflow-hidden">
                    <div class="px-6 py-4 border-b border-gray-200 bg-purple-50 flex justify-between items-center">
                        ...
                        <div class="flex space-x-2 items-center no-print">
                            <div class="relative">
                                ...
                                <input type="text" id="searchTransaksi" placeholder="Cari transaksi..." 
                                       class="bg-white border border-gray-300 pl-10 pr-4 py-2 rounded-lg focus:outline-none focus:ring-1 focus:ring-purple-500 text-sm">
                            </div>
                        </div>
                    </div>
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                ...
                                <?php while ($transaction = mysqli_fetch_assoc($transactions)): ?>
                                    <tr class="hover:bg-gray-50 transition transaksi-row">
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900 transaksi-id">#TRX-<?= $transaction['id'] ?></td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 transaksi-date"><?= date('d M Y, H:i', strtotime($transaction['date'])) ?></td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 transaksi-admin"><?= $transaction['admin_name'] ?></td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 transaksi-member"><?= $transaction['member_name'] ?? '-' ?></td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900 transaksi-total">Rp <?= number_format($transaction['total_price'], 0, ',', '.') ?></td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm transaksi-method">
                                            <span class="px-2 py-1 <?= $transaction['payment_method'] == 'tunai' ? 'bg-green-100 text-green-800' : 'bg-blue-100 text-blue-800'; ?> rounded-full text-xs">
                                                <?= ucfirst($transaction['payment_method']) ?>
                                            </span>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 no-print">
                                            <button onclick="showDetail(<?= $transaction['id'] ?>)" class="text-purple-600 hover:text-purple-900 transition">
    ...
    <div id="detailModal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center hidden z-50 no-print">
        <div class="bg-white rounded-xl shadow-lg w-full max-w-2xl p-6 relative">
            <button onclick="closeModal()" class="absolute top-4 right-4 text-gray-400 hover:text-gray-600 text-xl transition">&times;</button>
            <h3 class="text-xl font-bold mb-4 text-gray-800">Detail Transaksi</h3>
            <div class="mb-4 grid grid-cols-2 gap-4">
                <div class="text-gray-600"><strong class="text-purple-600">ID:</strong> <span id="modalTransactionId"></span></div>
                <div class="text-gray-600"><strong class="text-purple-600">Tanggal:</strong> <span id="modalDate"></span></div>
                <div class="text-gray-600"><strong class="text-purple-600">Kasir:</strong> <span id="modalAdmin"></span></div>
                <div class="text-gray-600"><strong class="text-purple-600">Member:</strong> <span id="modalMember"></span></div>
                <div class="text-gray-600"><strong class="text-purple-600">Total:</strong> <span id="modalTotal"></span></div>
                <div class="text-gray-600"><strong class="text-purple-600">Margin:</strong> <span id="modalMargin"></span></div>
                <div class="text-gray-600"><strong class="text-purple-600">Metode:</strong> <span id="modalMethod"></span></div>
                <div class="text-gray-600"><strong class="text-purple-600">Dibayar:</strong> <span id="modalPaid"></span></div>
                <div class="text-gray-600"><strong class="text-purple-600">Kembalian:</strong> <span id="modalChange"></span></div>
            </div>
            <h4 class="font-semibold mb-2 text-purple-600">Produk</h4>
            <div class="overflow-x-auto">
                <table class="w-full border border-gray-200">
                    <thead>
                        <tr class="bg-gray-50">
                            <th class="px-4 py-2 text-left text-purple-600">Nama Produk</th>
                            <th class="px-4 py-2 text-left text-purple-600">Harga</th>
                            <th class="px-4 py-2 text-left text-purple-600">Qty</th>
                            <th class="px-4 py-2 text-left text-purple-600">Margin</th>
                            <th class="px-4 py-2 text-left text-purple-600">Subtotal</th>
                        </tr>
                    </thead>
                    <tbody id="modalProducts" class="divide-y divide-gray-200"></tbody>
                </table>
            </div>
        </div>
    </div>
